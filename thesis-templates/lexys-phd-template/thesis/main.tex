...
\include{front_back_matter/Acknowledgments} %: Lexy!

\include{front_back_matter/Publications}
...
\cleardoublepage
\ctparttext{\centering Something wise}
...
\ctparttext{\centering Something new}
