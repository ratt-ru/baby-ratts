...
\usepackage[style=ieee,maxcitenames=3,mincitenames=1,maxbibnames=6,minbibnames=6]{biblatex}
...
\addbibresource{Main/Bibliography/Masters.bib} % The filename of the bibliography
...
\usepackage{amssymb}
\usepackage{amsthm}
\usepackage[math]{cellspace} % Necessary for adjusting matrix typesetting.
\usepackage{upgreek}
...
\usepackage[acronym,noredefwarn,style=super,nonumberlist,toc,nogroupskip=true]{glossaries}
\usepackage{tabularx}
\usepackage{listings}
...
% Set up some global maths stuff.
...
% 1. Short-hand for vectors/matrices
\def\*#1{\boldsymbol{\mathrm{#1}}}

% 2. Inner Product
\newcommand{\inpdt}[2]{\langle\,#1,#2\,\rangle}

% 3. Kronecker Product
\newcommand{\kron}[2]{\langle#1#2\rangle}

% 4. Redefine section headers for cleveref
